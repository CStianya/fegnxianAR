 ...
 *
 */
public abstract class MediaRecorderBase /*extends MediaRecorder*/ implements Callback, PreviewCallback, IMediaRecorder {
	...
	protected void prepareCameraParaments() {
		...
		Log.d("Rota","========="+String.valueOf(mFrameRate));
	...
	/** 压缩视频片段 */
	protected void conpressVideoParts() {
		new AsyncTask<Void, Void, Boolean>() {

			@Override
			protected Boolean doInBackground(Void... params) {

			String cmd = String.format("-y -i /sdcard/WeiXinRecordedDemo/0.mp4 -strict -2 -vcodec libx264 -preset ultrafast -crf 32 -acodec aac -ar 44100 -ac 2 -b:a 96k -s 640x480 -aspect 9:16 /sdcard/WeiXinRecordedDemo/1.mp4");
			Log.e("yasuo","aaaa");
					int i = UtilityAdapter.FFmpegRun("", cmd);
				return i == 0;
			}
