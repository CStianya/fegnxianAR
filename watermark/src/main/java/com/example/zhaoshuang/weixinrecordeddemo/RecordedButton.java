...
public class RecordedButton extends View {
  ...
  /*  @Override
    ...
    public void ingButtom(boolean ing){
        if(ing)inPaint.setColor(Color.RED);
        else inPaint.setColor(Color.WHITE);
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
       ...
       /* paint.setColor(Color.WHITE);*/
        canvas.drawCircle(measuredWidth/2, measuredWidth/2, radius2, inPaint);
